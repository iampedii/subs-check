...
type Config struct {
	...
	NodeNameTemplate     string    `yaml:"node-name-template"`
...
var GlobalConfig = &Config{
	// New config values with defaults for users who have not updated their config file.
	ListenPort:         ":8199",
	NotifyTitle:        "🔔 Node Status Update",
